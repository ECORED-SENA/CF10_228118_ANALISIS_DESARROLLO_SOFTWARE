  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Características  representativas en patrones de diseño
        p.mb-4 Afianzar las características más importantes de algunos patrones de diseño de #[i software].
